        ...
        <div className="project-detail-page" style={{ paddingTop: '2rem', paddingBottom: '6rem' }}>
            <div className="container">
                <Link to="/projects" style={{
                    ...
                    <ArrowLeft size={20} />
                    {t('projects.sitgesart.back_button')}
                </Link>
                    ...
                    >
                        ...
                        <div style={{ marginBottom: '3rem' }}>
                            <h2 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: 'var(--accent-primary)' }}>
                                {t('projects.sitgesart.detail_title')}
                            </h2>
                            <p style={{
                                fontSize: '1.2rem',
                                lineHeight: '1.8',
                        ...
                        <div>
                            <h2 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: 'var(--accent-primary)' }}>
                                {t('projects.sitgesart.features_title')}
                            </h2>
