...
const stackSections = [
    {
        title: "El Cervell (IA & Data Science)",
        items: [
            {
                name: "Google Gemini API",
                description: "El motor de raonament principal. La seva gran finestra de context em permet processar volums massius de dades amb una precisió quirúrgica.",
                viewBox: "0 0 24 24",
            ...
            {
                name: "OpenAI",
                description: "Estàndard de la indústria per a la generació de text i orquestració de lògica complexa en els meus fluxos de treball.",
                viewBox: "0 0 24 24",
            ...
            {
                name: "Python",
                description: "El llenguatge fonamental que em permet connectar la IA amb l'execució de codi i l'automatització.",
                viewBox: "0 0 24 24",
    ...
    {
        title: "Arquitectura i Gestió de Continguts (Web & Media)",
        items: [
            {
                name: "Cloudinary",
                description: "La meva solució per a la gestió intel·ligent de mitjans. L'utilitzo per optimitzar, emmagatzemar i servir imatges i vídeos de forma ultra-ràpida, assegurant que la web sigui lleugera sense perdre qualitat visual.",
                viewBox: "0 0 24 24",
            ...
            {
                name: "Firebase",
                description: "La infraestructura per a dades en temps real, emmagatzematge i autenticació segura d'usuaris.",
                viewBox: "0 0 24 24",
            ...
            {
                name: "React",
                description: "La llibreria per construir interfícies d'usuari dinàmiques i escalables mitjançant components.",
                viewBox: "0 0 24 24",
            ...
            {
                name: "Tailwind CSS",
                description: "Motor d'estil per dissenyar interfícies netes i minimalistes directament des del codi.",
                viewBox: "0 0 24 24",
                icon: <path d="M12.001,4.8c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 C13.666,10.618,15.027,12,18.001,12c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C16.337,6.182,14.976,4.8,12.001,4.8z M6.001,12c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 c1.177,1.194,2.538,2.576,5.512,2.576c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C10.337,13.382,8.976,12,6.001,12z" />
            },
            {
                name: "Vercel",
                description: "Plataforma de deployment que garanteix la màxima velocitat de càrrega i un rendiment òptim de la web.",
                viewBox: "0 0 24 24",
                icon: <path d="m12 1.608 12 20.784H0Z" />
            },
            {
                name: "GitHub",
                description: "Centre de control de versions on col·laboro amb la IA per mantenir un codi segur i organitzat.",
                viewBox: "0 0 24 24",
    ...
    {
        title: "Creació Creativa & Postproducció (Disseny & Vídeo)",
        items: [
            {
                name: "DaVinci Resolve",
                description: "Eina definitiva per a la postproducció de vídeo, utilitzada pel seu control cinematogràfic del color i potència en el muntatge professional.",
                viewBox: "0 0 24 24",
            ...
            },
            {
                ...
                description: "Creació de motion graphics per explicar conceptes abstractes d'IA de manera visual i senzilla.",
                viewBox: "0 0 24 24",
            ...
            },
            {
                ...
                description: "Pilar del disseny gràfic per a la creació de portades i elements visuals de marca personal.",
                viewBox: "0 0 24 24",
            ...
            },
            {
                ...
                description: "L'esquelet de disseny que dóna coherència visual i una experiència d'usuari futurista.",
                viewBox: "0 0 24 24",
        ...
        items: [
            {
                ...
                description: "El meu centre d'operacions configurat per al desenvolupament assistit per IA, on el prompt engineering i el codi convergeixen.",
                viewBox: "0 0 24 24",
